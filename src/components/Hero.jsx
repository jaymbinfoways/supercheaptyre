...
import img from "../assets/tyrebanner.png";
import BuyTyre from "./BuyTyre";

const SearchForm = () => {
  return (
    <div className="relative mt-4 sm:mt-6 md:mt-8 pointer-events-auto">
      <div className="relative bg-white rounded-xl sm:rounded-2xl shadow-2xl p-4 sm:p-6 md:p-8 z-10">
        <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium text-dark mb-4 sm:mb-6 text-center md:text-left">
          SEARCH FOR TYRES
        </h3>
      ...
      <section className="relative bg-dark text-white overflow-hidden w-full ">
        <div className="">
          <img
            src={img}
            alt="Ford Ranger"
            className="w-full h-full object-cover object-[60%_center] sm:object-center lg:object-right"
          />
